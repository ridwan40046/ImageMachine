...
extension Date {
    ...
    func changing (day: Int? = nil, month: Int? = nil, year: Int? = nil, hour: Int? = nil, minute: Int? = nil, second: Int? = nil) -> Date {
        var res = self;
        res.change(day: day, month: month, year: year, hour: hour, minute: minute, second: second);
        return res;
    }
    ...
    func offsetting  (day: Int? = nil, month: Int? = nil, year: Int? = nil, hour: Int? = nil, minute: Int? = nil, second: Int? = nil) -> Date {
        var res = self;
        res.offset(day: day, month: month, year: year, hour: hour, minute: minute, second: second);
        return res;
    }
